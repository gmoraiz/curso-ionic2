...
export class MyApp {
  pages : Array<{component: any, title: string, icon: string}>; // pages é um tipo Array com type generic.
  ...
  // metodo que será utilizado pela view para abrir a página que foi selecionado respectivamente.
